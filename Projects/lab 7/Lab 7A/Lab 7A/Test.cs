    ...
    class Test
    {
        ...
        public static void Run(int labNumber)
        {
            ...
            for (int ndx = 0; ndx < tests; ndx++)
            {
                ...
                if(submitted != null && submitted.GetType() == typeof(Circle))
                { 
                    if(Math.Round(expected.GetArea(),2) == Math.Round(((Circle)submitted).GetArea(),2))
                    {
                        success = true;
                    }
                }
                ...
                {
                    Console.WriteLine("Pass[" + (ndx + 1) + "]: score = " + testScore + " [ " + x + ", " + y + ", " +
                                         rad + " ]\tExpected: " + expected.GetArea() + "\tSubmitted: " +
                                         ((Circle)submitted).GetArea());
                }
                else
                {
                    Console.WriteLine("Pass[" + (ndx + 1) + "]: score = " + testScore + " [ " + x + ", " + y + ", " +
            ...
            for (int ndx = 0; ndx < tests; ndx++)
            {
                ...
                if (submitted != null && submitted.GetType() == typeof(Circle))
                {
                    if (expected.GetCircumference() == ((Circle)submitted).GetCircumference())
                    {
                        success = true;
                    }
                }
                ...
                {
                    Console.WriteLine("Pass[" + (ndx + 1) + "]: score = " + testScore + " [ " + x + ", " + y + ", " +
                                         rad + " ]\tExpected: " + expected.GetCircumference() + "\tSubmitted: " +
                                         ((Circle)submitted).GetCircumference());
                }
                else
                {
                    Console.WriteLine("Pass[" + (ndx + 1) + "]: score = " + testScore + " [ " + x + ", " + y + ", " +
        ...
        private static bool CompareCircles(MyCir c1,object c)
        {
            ...
            {
                Circle c2 = (Circle)c;
                if (c1.GetX() != c2.GetX() || c1.GetY() != c2.GetY() || c1.GetRadius() != c2.GetRadius())
                    same = false;
            }
            return same;
        }
